...
FLAGS_DEF = define_flags_with_default(
    env='Hopper-v2',
    data_set_name = 'hopper-medium-expert-v2',
    NHT_path = '/Users/cmuslimani/Projects/action_mapping/NHT/training_scripts/trained_maps/NHT/hopper-medium-expert-v2/dataset_percent_0.5/version_0',
    use_NHT = True,
